...
//ol.proj.get("EPSG:3857").setExtent([11870489.564187, -685582.051325, 11874355.927376, -683155.869605]);
var wms_layers = [];
...
lyr_APMSTerbaru_1.set('fieldAliases', {'Section': 'Section', 'PCI Rating': 'PCI Rating', });
lyr_APMSTerbaru_1.set('fieldImages', {'Section': 'TextEdit', 'PCI Rating': 'TextEdit', });
lyr_APMSTerbaru_1.set('fieldLabels', {'Section': 'inline label - visible with data', 'PCI Rating': 'inline label - visible with data', });
